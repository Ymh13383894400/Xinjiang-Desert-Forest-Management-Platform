...
import dataViewRouter from '@/router/modules/data_view'
// import observeRouter from '@/router/modules/observe'
import homePageRouter from '@/router/modules/homePage'
import deviceRouter from "@/router/modules/device";
...
export const constantRoutes = [    // 代表那些不需要动态判断权限的路由，如登录页、404、等通用页面
  ...
  //       name: 'Documentation',
  //       meta: { title: '历史数据', icon: 'documentation', affix: true }
  //     }
  //   ]
  // },
  // {
 ...
 */
export const asyncRoutes = [    //需求动态判断权限并通过 addRoutes 动态添加的页面
  // {
  //   path: '/permission',
  //   component: Layout,
