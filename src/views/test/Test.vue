    ...
    <div :key="key" style="margin-top:30px;">
      <div v-show="selectMethod === 'file'">
        ...
        <div v-show="fileUpload" style="text-align: center">
          ...
          <el-button style="margin: 20px 0" @click="returnPlantInfo" :disabled="btnFileDisable">{{"返回植物信息"}}</el-button>
...
export default {
  ...
  methods: {
    ...
    returnPlantInfo(){
      this.$router.push({path: '/samplePlot/samplePlantInfo', query: {samplePlotId: this.id}})
    },
    handleRolesChange() {
      this.key++
    },
